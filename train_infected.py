...
from datasets import Infected_Dataset
...
def main(args):
    ...
    for i, (train_set, val_set) in enumerate(kfold.split(x, y)):
        train_dataset = Infected_Dataset(
        ...
        valid_dataset = Infected_Dataset(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_save_path', default='/home/jxf/code/complications_pred/checkpoints/debug_infected', type=str)
    parser.add_argument('--log_dir', default='/home/jxf/code/complications_pred/logs/debug_infected', type=str)
    ...
    parser.add_argument('--x_path', default='/home/jxf/code/complications_pred/input/ckd_infected/x0.pkl', type=str)
    parser.add_argument('--y_path', default='/home/jxf/code/complications_pred/input/ckd_infected/y0_d90.pkl', type=str)
